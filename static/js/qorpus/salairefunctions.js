...
function apply_salaire_filters()
{
    ...
    table
        .clear()
        .draw();
        populate_salaire_table($('#mainCalendar').data('daterangepicker').startDate.format("YYYY-MM-DD"),$('#mainCalendar').data('daterangepicker').endDate.format("YYYY-MM-DD"),montantlower,montanthigher,valid_filter)}, 200);
