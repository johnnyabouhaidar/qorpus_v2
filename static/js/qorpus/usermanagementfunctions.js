...
function populate_table(){
    ...
    for (var i=0;i<users.length;i++)
    {
        ...
        var rolesmapping_dict=[['setup','Setup'],['doctors','Docteurs'],['payments','Paiements'],['facturation','Facturations'],['retrocession','Retrocessions'],['dentisterie','Dentisterie'],['encaissement','Encaissement'],['fraismateriel','Frais Materiel'],['paiement_medecin','Paiement du médecin'],['salaire','Salaire'],['employees','Employées'],['vershon','Versements Honoraires'],['reports','Reports Generation']]
