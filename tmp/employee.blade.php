    ...
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div>
                ...
                <a href="{{ route('doctors')}}" class="btn rounded-pill waves-effect waves-light btn-sm btn-primary-light">Medecins</a>
                <a href="{{ route('employee')}}" class="btn rounded-pill waves-effect waves-light btn-sm btn-primary-light  {{ request()->routeIs('employee') ? 'btn-active' : ''}}">Employés</a>
                <a href="{{ route('patients')}}" class="btn rounded-pill waves-effect waves-light btn-sm btn-primary-light">Patients</a>
            </div>
            <div class="btn-list">
                <a class="btn btn-primary btn-wave mb-0" href="{{ route('add-employee') }}" data-bs-effect="effect-rotate-left">
                    + Ajouter
                </a>
                ...
                <ul class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                    <li>
                        <button class="dropdown-item d-flex align-items-center" id="activeStatus">Validées</button>
                    </li>
                    <li>
                    ...
                    <table id="responsiveDataTable" class="table table-bordered text-nowrap" style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th>Pourcentage de l'employé</th>
                                <th>Date de fin</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="hstack gap-2">
                                        ...
                                        <a aria-label="anchor" href="{{ route('editemployee') }}" data-bs-effect="effect-rotate-left" class="btn btn-icon waves-effect waves-light btn-sm btn-primary-light"><i class="ri-edit-line" data-bs-toggle="tooltip" data-bs-placement="top" title="modifier"></i></a>
